      ...
      <div className="App">
        ...
        <header class="masthead" style={{ backgroundImage: `url(${background})` }}>
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="#about">{t("savoirplus.label")}</a>
            </div>
        </header>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <div class="masthead-subheading"></div>
                    <h2 class="section-heading text-uppercase"> {t("produit.label")}</h2>
                    <h3> {prod[0]}</h3>
                    <h3 class="section-subheading text-muted"> <i class="fa-solid fa-flag"></i> {t("origine.label")}: {zid[4]}<p>{t("datelimite.label")}:  {prod[3]}</p></h3>
                </div>
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="subheading">{t("etape1.label")}: {zid[0]}</h4>
                                <h7> {t("etape1date.label")}: {prod[2]}</h7>
                            </div>
                            <div class="timeline-body"><p class="text-muted"> {t("savoirplus.label")}  </p>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="subheading">{t("etape2.label")}: {zdist[0]}</h4>
                                <h7>{t("date.label")}: {prod[4]}</h7>
                            </div>
                            <div class="timeline-body"><p class="text-muted">{t("savoirplus.label")} </p>
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="subheading">{t("etape3.label")}: {zu[0]}</h4>
                                <h7>{t("date.label")}: {prod[7]}</h7>
                            </div>
                            <div class="timeline-body"><p class="text-muted">{t("savoirplus.label")}</p>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="subheading">{t("etape4.label")}: {zret[0]} </h4>
                                <h7>{t("date.label")}: {prod[5]}</h7>
                            </div>
                            <div class="timeline-body"><p class="text-muted">{t("savoirplus.label")}</p>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h3 class="section-heading text-uppercase">{t("rate.label")}</h3>
                    <StarRating />
                </div>
            </div>
        </section>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <div style={{ display: "flex", justifyContent: "center",  alignitems: "center"}}>
                                            <iframe
                                             title="myFrame"
                                            src="https://www.youtube.com/embed/zh0DdJdsuAo"
                                             frameBorder="0" 
                                             allowFullScreen=""
